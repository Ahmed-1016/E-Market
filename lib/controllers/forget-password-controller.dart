...
class ForgertPasswordController extends GetxController { // تعريف كلاس وحدة التحكم لنسيان كلمة المرور
  ...
  Future<void> ForgetPasswordMethod( // تعريف دالة لنسيان كلمة المرور
    String userEmail, // البريد الإلكتروني للمستخدم
  ) async {
    try {
      EasyLoading.show(status: "Please wait"); // عرض رسالة "Please wait" أثناء التحميل

      await _auth.sendPasswordResetEmail(email: userEmail); // إرسال بريد إلكتروني لإعادة تعيين كلمة المرور
