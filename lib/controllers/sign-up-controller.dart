...
class SignUpController extends GetxController { // تعريف كلاس وحدة التحكم لتسجيل المستخدمين
  ...
  Future<UserCredential?> signUPMethod( // تعريف دالة لتسجيل المستخدمين
    ...
    try {
      ...
      await userCredential.user!.sendEmailVerification(); // إرسال بريد إلكتروني لتفعيل الحساب
